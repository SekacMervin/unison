...
const Others = () => 
{
    ...
    const GetOthersInzerts = async () =>
    {
        const inzertData = await GetOthersInzertsFromDatabase();
...
/// 
const GetOthersInzertsFromDatabase =  async () =>
{
    try
    {
        const response = await fetch("https://localhost:7020/api/inzert/selection/2");
